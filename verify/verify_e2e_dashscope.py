...
VERIFY_META = {'features': 'dashscope 全链路 6 步 + 同进程 deepseek 切换隔离回归（est 已按 2026-09-20 实测 ¥1.013 校准）', 'tier': 'network', 'providers': ['dashscope', 'deepseek'], 'est_seconds': 150, 'est_cost_cny': 1.1, 'routes': ['/api/new_session', '/api/run_step', '/api/stream/{session_id}/{run_id}', '/api/session_records/{session_id}', '/api/reset_session'], 'requires': ['keys', 'network']}
